...
VALUES
    ('Сотников Кирилл Артёмович'),
    ('Ковалёв Сергей Николаевич'),
    ('Петров Николай Фиофанович'),
    ('Орлова Ирина Олеговна'),
    ('Кондратова Анна Викторовна'),
    ('Шипенько Дарья Никифоровна'),
    ('Емельяненко Дмитрий Сапегович'),
    ('Климко Олег Сергеевич'),
    ('Домашенко Инга Фёдоровна'),
    ('Акрень Клим Дмитриевич'),
    ('Неугадайко Дарья Ильевна'),
    ('Догадайко Михаил Арсеньевич'),
    ('Разгадай Дмитрий Арсеньевич'),
    ('Алфёрова Данна Даниловна'),
    ('Укрупненко Михаил Егорович'),
    ('Замшелов Дмитрий Александрович'),
    ('Краснова Алина Артёмовна'),
    ('Захудалов Михаил Дмитриевич'),
    ('Закрутко Анна Леонидовна'),
    ('Леонидов Михаил Джабулаевич');
